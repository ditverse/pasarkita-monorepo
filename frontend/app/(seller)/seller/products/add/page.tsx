  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        // If backend supports base64 image, we could send it. 
        // For now, we mock the image logic if backend doesn't handle it yet.
  ...
  return (
    <div>
      ...
      <div className="pk-card" style={{ padding: 32, maxWidth: 640, background: '#fff' }}>
        {error && (
          <div style={{ padding: 12, marginBottom: 20, background: 'rgba(220,38,38,0.1)', color: '#dc2626', borderRadius: 8, fontSize: 14 }}>
            {error}
          </div>
        )}
